        ...
        if (result.success) {
            ...
            document.getElementById('results').innerHTML = `
                <div class="results">
                    ...
                    <p>You now have historical price data for all monitored sites.</p>
                ...
                <div class="results">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 15px; margin: 20px 0;">
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; text-align: center;">
                            ...
                            <p style="font-size: 24px; font-weight: bold; margin: 5px 0; color: #007bff;">${summary.total_sites}</p>
                        </div>
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; text-align: center;">
                            <h5 style="margin: 0; color: #495057;">Data Points</h5>
                            <p style="font-size: 24px; font-weight: bold; margin: 5px 0; color: #28a745;">${summary.total_data_points}</p>
                        </div>
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; text-align: center;">
                            <h5 style="margin: 0; color: #495057;">Avg Price</h5>
                            <p style="font-size: 24px; font-weight: bold; margin: 5px 0; color: #ffc107;">$${summary.average_price}</p>
                        </div>
                        <div style="background: #f8f9fa; padding: 15px; border-radius: 8px; text-align: center;">
                            <h5 style="margin: 0; color: #495057;">Price Range</h5>
                            <p style="font-size: 16px; font-weight: bold; margin: 5px 0; color: #dc3545;">$${summary.price_range.min} - $${summary.price_range.max}</p>
                        </div>
                    </div>
                    
                    <div style="margin-top: 20px;">
                        <button onclick="showPriceComparison()" class="btn btn-info" style="margin: 5px;">
                            Price Comparison Chart
                        </button>
                        <button onclick="showPriceTrends()" class="btn btn-success" style="margin: 5px;">
                            Price Trends Chart
                        </button>
                    </div>
                </div>
